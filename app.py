...
def simulate_generator(symbol, horizon_key, sims):
    ...
    # 僅取前2000條樣本線繪圖，其餘僅在後台計算
    sample_n = min(2000, all_paths.shape[0])
    sample_paths = all_paths[:sample_n]
    ...
    if ma20>ma50 and macd_hist>0 and rsi14<70:
        advice="趨勢偏多：建議逢低分批買入，並依多頭動能續抱持有。"
    elif ma20>ma50 and rsi14>=70:
        advice="多頭趨勢明顯但 RSI 過熱，建議等待回檔至均線後再布局。"
    elif ma20<ma50 and macd_hist<0:
        advice="趨勢轉空：建議逢高賣出或觀望以控風險。"
    else:
        advice="訊號混合，建議先觀望，待趨勢訊號更明確再操作。"
    ...
    <div style="font-size:1rem; line-height:1.5;">
      ...
      <ul>
        ...
        <li>RSI(14)={rsi14:.2f}，{'過熱' if rsi14>70 else ('超賣' if rsi14<30 else '中性')}。</li>
